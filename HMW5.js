...
function getSortedList() {
  worker1.salary = worker1.salary_value();
  worker2.salary = worker2.salary_value();
  worker3.salary = worker3.salary_value();

  let sortedSalary = [worker1, worker2, worker3];
  sortedSalary.sort(function (a, b) {
    return a.salary - b.salary;
  });
  console.log("Sorted salary:");
  for (let i = 0; i < sortedSalary.length; i++) {
    console.log(sortedSalary[i].fullName + ": " + sortedSalary[i].salary);
  }
}
